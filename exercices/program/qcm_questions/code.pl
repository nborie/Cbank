...
right_answer1=Les blocs C s'identifient en allant à la ligne et en rajoutant 4 espaces.
right_answer2=On peut imbriquer les bloc les uns dans les autres.
right_answer3=Les instructions se terminent par le caractère ;
right_answer4=Pour définir une fonction, on ouvre une accolade à la suite de son prototype.
right_answer5=Quand on a plus d'une instruction, il faut mettre des accolades.
